...
public class Window
{
    ...
    {
        jFrame.gameloopThread = new GameloopThread(givenGameloop);
    }
    public void startGameloop()
    {
        if(jFrame.gameloopThread != null)
        {
            jFrame.gameloopThread.start();
        }
    }
    public void setFPS(int givenFPS)
    {
        if(jFrame.gameloopThread != null)
        {
            jFrame.gameloopThread.fps = givenFPS;
        }
    }
    public int getFPS()
    {
        if(jFrame.gameloopThread != null)
        {
            return jFrame.gameloopThread.fps;
        }
        else
        return -1;
    }
    ...
    {
        jFrame.canvas.renderedObjects.add(new devtaube.wein2d.renderedobjects.Rectangle(posX, posY, sizeX, sizeY, colorR, colorG, colorB));
    }
    public void drawRect(int posX, int posY, int sizeX, int sizeY, int colorA, int colorR, int colorG, int colorB)
    {
        jFrame.canvas.renderedObjects.add(new devtaube.wein2d.renderedobjects.Rectangle(posX, posY, sizeX, sizeY, colorA, colorR, colorG, colorB));
    }

    public void drawOval(int posX, int posY, int sizeX, int sizeY, int colorR, int colorG, int colorB)
    {
        jFrame.canvas.renderedObjects.add(new devtaube.wein2d.renderedobjects.Oval(posX, posY, sizeX, sizeY, colorR, colorG, colorB));
    }
    public void drawOval(int posX, int posY, int sizeX, int sizeY, int colorA, int colorR, int colorG, int colorB)
    {
        jFrame.canvas.renderedObjects.add(new devtaube.wein2d.renderedobjects.Oval(posX, posY, sizeX, sizeY, colorA, colorR, colorG, colorB));
    }

    public void drawSprite(Sprite sprite, int posX, int posY)
    {
        jFrame.canvas.renderedObjects.add(new devtaube.wein2d.renderedobjects.Sprite(sprite.getImage(), posX, posY));
    }
    public void drawSprite(Sprite sprite, int posX, int posY, int colorA)
    {
        jFrame.canvas.renderedObjects.add(new devtaube.wein2d.renderedobjects.Sprite(sprite.getImage(), posX, posY, colorA));
    }
    public void drawSprite(Sprite sprite, int posX, int posY, int sizeX, int sizeY)
    {
        jFrame.canvas.renderedObjects.add(new devtaube.wein2d.renderedobjects.Sprite(sprite.getImage(), posX, posY, sizeX + posX, sizeY + posY));
    }
    public void drawSprite(Sprite sprite, int posX, int posY, int sizeX, int sizeY, int colorA)
    {
        jFrame.canvas.renderedObjects.add(new devtaube.wein2d.renderedobjects.Sprite(sprite.getImage(), posX, posY, sizeX + posX, sizeY + posY, colorA));
    }
    ...
    {
        jFrame.canvas.renderedObjects.add(new devtaube.wein2d.renderedobjects.Sprite(sprite.getImage(), posX, posY, sizeX + posX, sizeY + posY, srcPosX, srcPosY, srcSizeX + srcPosX, srcSizeY + srcPosY));
    }
    ...
    {
        jFrame.canvas.renderedObjects.add(new devtaube.wein2d.renderedobjects.Sprite(sprite.getImage(), posX, posY, sizeX + posX, sizeY + posY, srcPosX, srcPosY, srcSizeX + srcPosX, srcSizeY + srcPosY, colorA));
    }

    public void drawText(String content, int posX, int posY, int fontSize, String fontFamily, int colorR, int colorG, int colorB)
    {
        jFrame.canvas.renderedObjects.add(new devtaube.wein2d.renderedobjects.Text(content, posX, posY + fontSize, fontSize, fontFamily, colorR, colorG, colorB));
    }
    ...
    {
        jFrame.canvas.renderedObjects.add(new devtaube.wein2d.renderedobjects.Text(content, posX, posY + fontSize, fontSize, fontFamily, colorA, colorR, colorG, colorB));
    }
    ...
    {
        jFrame.canvas.renderedObjects.add(new devtaube.wein2d.renderedobjects.Text(content, posX, posY + fontSize, positioning, fontSize, fontFamily, colorR, colorG, colorB));
    }
    ...
    {
        jFrame.canvas.renderedObjects.add(new devtaube.wein2d.renderedobjects.Text(content, posX, posY + fontSize, positioning, fontSize, fontFamily, colorA, colorR, colorG, colorB));
    }

    public void fill(int colorR, int colorG, int colorB)
    {
        jFrame.canvas.renderedObjects.add(new devtaube.wein2d.renderedobjects.Rectangle(colorR, colorG, colorB));
    }
    public void fill(int colorA, int colorR, int colorG, int colorB)
    {
        jFrame.canvas.renderedObjects.add(new devtaube.wein2d.renderedobjects.Rectangle(colorA, colorR, colorG, colorB));
    }
