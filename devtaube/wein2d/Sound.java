...
public class Sound
{
    ...
    public Sound(String filePath)
    {
        ...
        if (!(new File(fullFilePath).isFile()))
            throw new IllegalArgumentException("Sound file at '" + fullFilePath + "' not found.");
        else
    ...
    public final void setVolume(double loudness)
    {
        volume.setValue((float) (range * loudness) + volume.getMinimum());
    }
    // Set Frame Position ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public final void setFramePosition(int frame) { sound.setFramePosition(frame); }
    // Play ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public void play()
    {
        stop();
    ...
    // Loop ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public final void loop(boolean looping)
    {
        if (looping)
        {
