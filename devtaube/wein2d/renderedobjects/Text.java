package wein2d.renderedobjects;
...
public class Text implements RenderedObject
{
    ...
    public Text(String content, int posX, int posY, String positioning, int fontSize, String fontFamily, int colorR, int colorG, int colorB) // draw text with custom font
    {
        this.content = content;
        this.posX = posX;
        this.posY = posY;
    ...
    public Text(String content, int posX, int posY, String positioning, int fontSize, String fontFamily, int colorA, int colorR, int colorG, int colorB) // draw text with custom font and alpha
    {
        this.content = content;
        this.posX = posX;
        this.posY = posY;
